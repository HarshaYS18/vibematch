...
def _database_url() -> str:
    ...
    if settings.is_production:
        raise RuntimeError("ECONOMY_DATABASE_URL is required for Economy bulk worker")
...
if database_url.startswith(("postgresql://", "postgresql+")):
    ...
    connect_args["application_name"] = "funkey-economy-bulk-worker"
    ...
    pool_options = {
        "pool_size": settings.ECONOMY_BULK_WORKER_DB_POOL_SIZE,
        "max_overflow": settings.ECONOMY_BULK_WORKER_DB_MAX_OVERFLOW,
