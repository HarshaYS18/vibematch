...
def upgrade() -> None:
    ...
    if bind.dialect.name == "postgresql":
        ...
        return
    op.add_column("store_items", sa.Column("availability_starts_at", sa.DateTime(), nullable=True))
    op.add_column("store_items", sa.Column("availability_ends_at", sa.DateTime(), nullable=True))
