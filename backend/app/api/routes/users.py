...
def _profile_visit_payload(db: Session, visit: ProfileVisit) -> ProfileVisitRecordResponse:
    ...
    return ProfileVisitRecordResponse(
        id=f"visitor_{visit.profile_owner_user_id}_{visit.visitor_user_id}",
        visitor_user_id=visitor.id,
        visitor_public_user_id=visitor.public_user_id,
        visitor_visible_id=str(visible_id),
        visitor_display_name=_display_name(visitor),
        visitor_username=visitor.username,
        visitor_avatar_url=visitor.avatar_url,
        visitor_role_label=role_badge.display_title,
