...
def roll_lucky_gift(payload: LuckyGiftRollRequest, current_user: User = Depends(get_current_user)):
    ...
    total_coin_value = int(gift["coin_value"]) * payload.quantity
    try:
        return gift_catalog_service.roll_lucky_multiplier(
