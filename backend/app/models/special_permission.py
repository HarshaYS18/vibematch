...
class SpecialPermissionName(str, Enum):
    ...
    MANAGE_STORE_CATALOG = "MANAGE_STORE_CATALOG"
    MANAGE_ASSETS = "MANAGE_ASSETS"
    MANAGE_ECONOMY_RULES = "MANAGE_ECONOMY_RULES"
    MANAGE_VIP_RULES = "MANAGE_VIP_RULES"
    MANAGE_SVIP_RULES = "MANAGE_SVIP_RULES"
    MANAGE_LEVEL_RULES = "MANAGE_LEVEL_RULES"
    MANAGE_ROLES = "MANAGE_ROLES"
    MANAGE_PERMISSIONS = "MANAGE_PERMISSIONS"
    GRANT_STEALTH = "GRANT_STEALTH"
    USE_STEALTH = "USE_STEALTH"
    MANAGE_ROOM_PRIVACY = "MANAGE_ROOM_PRIVACY"
    MANAGE_ROOM_ASSETS = "MANAGE_ROOM_ASSETS"
    MANAGE_GIFTS = "MANAGE_GIFTS"
    MANAGE_GIFT_CATEGORIES = "MANAGE_GIFT_CATEGORIES"
