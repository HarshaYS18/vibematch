        ...
        for (var j = 0; j < grammar[type]!.length; j += 1) {
          ...
          if (obj['reg'] == null) {
            if (obj['name'] != null) {
              ...
              // Some grammar entries intentionally have neither a name nor a
              // regex and are handled by the generic invalid-line fallback
              // below. Upstream prints "trying to add null key" here even
              // though parsing continues correctly. Keep behavior identical
