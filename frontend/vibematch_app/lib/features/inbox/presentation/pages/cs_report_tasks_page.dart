              ...
              child: Container(
                ...
                child: const Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Review incoming tasks and choose the right next step.',
                        style: TextStyle(
                          color: _muted,
                          fontSize: 12.2,
                          height: 1.35,
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return _ReportTaskCard(
                      ...
                      onForward: task.isPending
                          ...
                          : null,
                      onAction: task.status == InboxReportStatus.acceptedEscalated
                          ? () => _openActionSheet(task)
                          : null,
                    );
                  },
                ),
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(
                      task.reportedUserName,
                      maxLines: 1,
                      overflow: TextOverflow.ellipsis,
                      style: const TextStyle(
                        color: _CsReportTasksPageState._ink,
                        fontSize: 14.5,
                        fontWeight: FontWeight.w800,
                      ),
                    ),
          ...
          Text(
            task.reason,
            style: const TextStyle(
              color: _CsReportTasksPageState._muted,
              fontSize: 12.2,
          ...
          if (task.csNote != null || task.monitorAction != null) ...[
            ...
            Container(
              ...
              child: Text(
                task.monitorAction ?? task.csNote!,
                style: const TextStyle(
              ...
              children: [
                ...
                Expanded(
                  child: _TaskButton(
                    ...
                    color: _CsReportTasksPageState._blue,
                    onTap: onForward,
                  ),
                ),
              ],
...
class _CountPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: _CsReportTasksPageState._blue.withValues(alpha: 0.10),
        borderRadius: BorderRadius.circular(999),
        border: Border.all(color: _CsReportTasksPageState._blue.withValues(alpha: 0.18)),
      ),
      child: Text(
        '$count',
        style: const TextStyle(
