              ...
              child: Column(
                children: [
                  ...
                  SwitchListTile(
                    ...
                    activeThumbColor: InboxLightPremiumTokens.aqua,
                    title: const Text(
                ...
                children: [
                  _ActionRow(
                    ...
                    subtitle: backup.lastBackupAt == null
                        ...
                        : 'Last backup: ${inboxLocalTimeLabel(backup.lastBackupAt!)}',
                  ...
                  _ActionRow(
                    ...
                    subtitle: backup.lastRestoreAt == null
                        ...
                        : 'Last restore: ${inboxLocalTimeLabel(backup.lastRestoreAt!)}',
...
class _GoogleDriveSetupSheetState extends State<_GoogleDriveSetupSheet> {
  ...
  Future<void> _connect() async {
    ...
    if (trimmedCode.isEmpty) {
      _toast('Paste the Google Drive authorization code first.');
      return;
    }
    setState(() => _busy = true);
    try {
              ...
              if (_authUrl != null) ...[
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(16),
                    border: Border.all(
                      color: InboxLightPremiumTokens.warmBorder,
                    ),
                  ),
                  child: Text(
                    _authUrl!,
  ...
  InputDecoration _inputDecoration(String label, IconData icon) {
    return InputDecoration(
      prefixIcon: Icon(icon, color: InboxLightPremiumTokens.ink, size: 20),
      labelText: label,
        ...
        child: Center(
          child: Row(
            ...
            children: [
              Icon(
                icon,
                color: dark ? Colors.white : InboxLightPremiumTokens.ink,
                size: 18,
              ),
              const SizedBox(width: 6),
              Text(
        ...
        child: Row(
          children: [
            Container(
              ...
              height: 42,
              decoration: BoxDecoration(
                color: InboxLightPremiumTokens.violet.withValues(alpha: 0.11),
