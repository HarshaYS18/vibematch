...
class _InboxChatPageState extends State<InboxChatPage> {
  ...
  Color _chatSurfaceColor(InboxChatThemeChoice choice) {
    if (choice.key == 'royal_dark') return const Color(0xFF101014);
              ...
              Expanded(
                child: Container(
                  decoration: BoxDecoration(
                    color: _chatSurfaceColor(chatTheme),
                  ),
                  child: ListView.separated(
                    ...
                    separatorBuilder: (context, index) {
                      ...
                      return SizedBox(
                        height: current.isMine == next.isMine ? 4 : 10,
                      );
                    },
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: const BoxDecoration(
        color: Colors.white,
        border: Border(
          bottom: BorderSide(color: Color(0xFFEDEDEF), width: 0.8),
        ),
      ),
      child: Row(
        children: [
...
class _HeaderAvatarText extends StatelessWidget {
  ...
  Widget build(BuildContext context) => DecoratedBox(
    decoration: BoxDecoration(color: conversation.colors.first),
    child: Center(
      child: Text(
        ...
        child: Stack(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: mine ? const Color(0xFF3797F0) : const Color(0xFFF1F1F3),
                ...
                border: mine
                    ? null
                    : Border.all(color: const Color(0xFFEDEDEF)),
              ),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      if (showTime &&
                          message.id == '__inline_time_disabled__') ...[
                        Text(
  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: Row(
      ...
      children: [
        Icon(
          icon,
          color: mine ? Colors.white70 : const Color(0xFF71717A),
          size: 12,
        ),
        const SizedBox(width: 4),
        Text(
...
class _ReplySnippet extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(
      color: mine ? Colors.white.withValues(alpha: 0.14) : Colors.white,
      borderRadius: BorderRadius.circular(13),
      border: Border(
        left: BorderSide(
          color: mine ? Colors.white70 : const Color(0xFF3797F0),
          width: 3,
        ),
      ),
    ),
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            height: 34,
            decoration: BoxDecoration(
              color: const Color(0xFF3797F0).withValues(alpha: 0.10),
              shape: BoxShape.circle,
            ),
            child: const Icon(
          ...
          const SizedBox(height: 4),
          const Text(
            'Access is checked before entry',
            style: TextStyle(
              color: Color(0xFF71717A),
              fontSize: 11.5,
              fontWeight: FontWeight.w600,
...
class _PillAction extends StatelessWidget {
  ...
  Widget build(BuildContext context) => InkWell(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        color: filled ? const Color(0xFF3797F0) : const Color(0xFFF7F7F8),
        borderRadius: BorderRadius.circular(999),
        border: Border.all(
          color: filled ? const Color(0xFF3797F0) : const Color(0xFFEDEDEF),
        ),
      ),
      child: Row(
        ...
        children: [
          Icon(
            icon,
            color: filled ? Colors.white : const Color(0xFF111114),
            size: 14,
          ),
          const SizedBox(width: 4),
          Text(
...
class _ReadReceipt extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final color = switch (status) {
      InboxMessageStatus.read => mine ? Colors.white : const Color(0xFF3797F0),
      InboxMessageStatus.failed => const Color(0xFFEF4444),
      _ => mine ? Colors.white70 : const Color(0xFF71717A),
    };
...
class _ActionTile extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final color = danger ? const Color(0xFFEF4444) : const Color(0xFF111114);
    return InkWell(
      borderRadius: BorderRadius.circular(16),
      onTap: onTap,
      child: Padding(
