                        ...
                        children: [
                          ...List.generate(
                            ...
                            (dotIndex) => AnimatedContainer(
                              ...
                              height: 7,
                              decoration: BoxDecoration(
                                color: Colors.white.withValues(alpha: dotIndex == selectedIndex ? 0.95 : 0.38),
                                borderRadius: BorderRadius.circular(999),
                              ),
                            ),
                          ),
                              ...
                              child: Container(
                                ...
                                child: const Row(
                                  children: [
                                    ...
                                    SizedBox(width: 5),
                                    Text('Manage', style: TextStyle(color: Colors.white, fontSize: 11, fontWeight: FontWeight.w900)),
                                  ],
                                ),
                              ),
                            ),
