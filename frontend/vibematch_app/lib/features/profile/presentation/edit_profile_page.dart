...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  late FriendGenderPreference _friendGenderPreference =
      friendGenderPreferenceForEdit(widget.user.friendGenderPreference);
  late FriendMaritalPreference _friendMaritalPreference =
      friendMaritalPreferenceForEdit(widget.user.friendMaritalPreference);
  late MaritalStatus _maritalStatus = maritalStatusForEdit(
  ...
  Future<void> _pickAndUploadAvatar() async {
    ...
    try {
      ...
      await _saveProfile(
        ...
        successMessage: 'Avatar updated across the app.',
      );
              ...
              child: ListView(
                ...
                children: [
                  ...
                  _EditSection(
                    ...
                    children: [
                      _DropdownTile(
                        ...
                        values: profileProfessionOptions
                            .map((item) => item.label)
                            .toList(),
                        onChanged: (value) =>
                  ...
                  _EditSection(
                    title: 'Interests',
                    subtitle:
                        'Pick real interests for profile display and match percentage.',
                    children: [
                  ...
                  _EditSection(
                    ...
                    subtitle:
                        'Used to calculate viewer-specific match percentage on public profiles.',
                    children: [
                      _OptionWrap<FriendGenderPreference>(
                        ...
                        textFor: (item) => item.label,
                        onSelected: (item) =>
                            setState(() => _friendGenderPreference = item),
                      ),
                      _OptionWrap<FriendMaritalPreference>(
                        ...
                        textFor: (item) => item.label,
                        onSelected: (item) =>
                            setState(() => _friendMaritalPreference = item),
                      ),
                    ],
                  ),
                ],
        ...
        InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: const Color(
                0xFF251538,
              ).withValues(alpha: saving ? 0.55 : 1),
              borderRadius: BorderRadius.circular(999),
            ),
            child: Text(
              saving ? 'Saving...' : 'Save',
          ...
          Expanded(
            child: Text(
              uploading
                  ...
                  : 'Upload Avatar. Uses square 1:1 crop with 3x3 grid and syncs immediately across profile, mini-card and chatrooms.',
              style: const TextStyle(
  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: Column(
      ...
      children: [
        Row(
          children: [
            Icon(category.icon, color: const Color(0xFF6D5DF6), size: 17),
            const SizedBox(width: 6),
            Text(
              category.name,
              style: const TextStyle(
            ...
            return InkWell(
              ...
              child: Container(
                ...
                child: Text(
                  interest,
                  style: TextStyle(
                    color: active ? Colors.white : const Color(0xFF5F526B),
                    fontSize: 11.5,
                    fontWeight: FontWeight.w900,
                  ),
                ),
