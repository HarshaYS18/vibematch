...
class MePage extends StatelessWidget {
  ...
  static const int _mockVipLevel = 25;
  static const int _mockSvipLevel = 3;
  static const bool _mockVipFrozen = false;
  static const int _mockDiamonds = 128500;
  static const int _mockCoins = 3420000;
  static const bool _mockIsAgencyHost = false;
  static const String _mockCoverPhotoStatus = 'Premium cover photo ready';

  static const _PresenceStatus _mockPresence = _PresenceStatus.online;
  static const String _mockLastSeenText = 'online';
  static const String? _mockCurrentRoomName = 'Founder Lounge';
  static const String _mockFamilyName = 'Moon Fam';
  static const int _mockFamilyLevel = 12;
    ...
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (_) => PublicProfileViewPage(
          user: user,
          vipLevel: _mockVipLevel,
          svipLevel: _mockSvipLevel,
          presenceLabel: _mockLastSeenText,
          currentRoomName: _mockCurrentRoomName,
          relationshipLabel: _relationshipTypeForUser(user),
          familyName: _mockFamilyName,
          familyLevel: _mockFamilyLevel,
        ),
      ),
    );
  }

  String _relationshipTypeForUser(CurrentUser user) {
  ...
  String? _profileTag(String role) {
    ...
    if (_mockIsAgencyHost) return 'Host';

    return null;
  }

  Color _vipMainColor(int level) {
  ...
  Widget build(BuildContext context) {
    final displayName = user.displayName ?? user.username ?? 'Vibe User';
    final publicId = user.publicUserId.toString();
    final role = user.primaryRole;
    final roleTag = _profileTag(role);
    final relationshipType = _relationshipTypeForUser(user);
    final vipColor = _vipMainColor(_mockVipLevel);
    final vipDark = _vipDarkColor(_mockVipLevel);
    ...
    final items = [
      ...
      _MeItem(
        ...
        subtitle: 'VIP $_mockVipLevel active · SVIP $_mockSvipLevel monthly',
        ...
        child: ListView(
          ...
          children: [
            _PremiumProfileHero(
              ...
              vipLevel: _mockVipLevel,
              svipLevel: _mockSvipLevel,
              vipFrozen: _mockVipFrozen,
              vipColor: vipColor,
              vipDark: vipDark,
              diamonds: _formatNumber(_mockDiamonds),
              coins: _formatNumber(_mockCoins),
              presence: _mockPresence,
              lastSeenText: _mockLastSeenText,
              currentRoomName: _mockCurrentRoomName,
              familyName: _mockFamilyName,
              familyLevel: _mockFamilyLevel,
              onFamilyTap: () => _showAction(
                context,
                'Family page with events, members and rewards will open.',
              ),
              onAvatarTap: () => _openMyProfilePage(context),
              onQrTap: () => _showAction(
                context,
              ...
              onVipTap: () => _showAction(
                context,
                'VIP / SVIP details will open.',
              ),
              onRoomTap: () => _showAction(
                context,
                'Open $_mockCurrentRoomName room preview. Secret Vibe rooms will be hidden later.',
              ),
            ),
            const SizedBox(height: 14),
            _VipSvipPanel(
              ...
              onVipTap: () => _showAction(
                context,
                'VIP progress, recharge points, freeze/reactivation rules will open.',
              ),
              onSvipTap: () => _showAction(
                context,
                'Monthly SVIP benefits and recharge target will open.',
              ),
            ),
            const SizedBox(height: 14),
            _RelationshipHolder(
              relationshipLabel: relationshipType,
              onSeeAllTap: () => _showAction(
                context,
                'Relationships full page will open.',
              ),
              onCpTap: () => _showAction(
                context,
                'Love CP card will open.',
              ),
              onBestieTap: () => _showAction(
                context,
                'Bestie relationship details will open.',
              ),
              onFamilyTap: () => _showAction(
                context,
                '$relationshipType relationship details will open.',
              ),
            ),
            const SizedBox(height: 14),
            Row(
              children: [
                ...
                _ProfileStat(
                  ...
                  onTap: () => _showAction(
                    context,
                    'Recent profile visitors will open.',
                  ),
                ),
              ],
            ),
          ...
          slivers: [
            SliverToBoxAdapter(
              child: _MyProfileHeader(
                ...
                onEditTap: () => _showAction(
                  context,
                  'Edit public profile page will open.',
                ),
                ...
                onRoomTap: () => _showAction(
                  context,
                  'Open $currentRoomName room preview if privacy rules allow it.',
                ),
              ),
            ),
            SliverToBoxAdapter(
              child: Padding(
                ...
                child: _BioInfoPanel(
                  bio:
                      'Founder Owner of Vibe Match. Building premium live rooms, Vibes, gifts, games and a trusted social-audio community.',
                  age: '27',
                  gender: 'Male',
                  interests: const [
                    'Music Rooms',
                  ...
                  onEditTap: () => _showAction(
                    context,
                    'Bio, age, gender and interests editor will open.',
                  ),
                ),
              ),
            ),
            SliverToBoxAdapter(
              child: Padding(
                padding: const EdgeInsets.fromLTRB(18, 16, 18, 0),
                child: _PresencePrivacyPanel(
                  presence: presence,
                  lastSeenText: lastSeenText,
                  currentRoomName: currentRoomName,
                  onTap: () => _showAction(
                    context,
                    'Presence privacy settings will open. Secret Vibe rooms must never be exposed.',
                  ),
                ),
              ),
            ),
            SliverToBoxAdapter(
              child: Padding(
                padding: const EdgeInsets.fromLTRB(18, 16, 18, 0),
                child: _VibesRulesPanel(
                  onTap: () => _showAction(
                    context,
                    'Vibes rules and mention privacy settings will open.',
                  ),
                ),
              ),
            ),
            ...
            SliverPadding(
              ...
              sliver: SliverList.separated(
                itemCount: _mockMyVibes.length,
                separatorBuilder: (context, index) =>
                    const SizedBox(height: 14),
                itemBuilder: (context, index) {
                  final vibe = _mockMyVibes[index];
                  ...
                  return _MyVibeCard(
                    ...
                    onCommentTap: () => _showAction(
                      context,
                      'Comments will open. @name and @all mentions in comments will notify later from backend.',
                    ),
                    onShareTap: () => _showAction(
                      context,
                      'Share this Vibe.',
...
class _MyProfileHeader extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final isOnline = presence == _PresenceStatus.online;
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: const Color(0xFF4A2A63).withValues(alpha: 0.22),
            blurRadius: 34,
            offset: const Offset(0, 16),
          ),
        ],
          ...
          Padding(
            ...
            child: Column(
              children: [
                ...
                _PremiumAvatar(
                  displayName: displayName,
                  vipColor: const Color(0xFFFFD36A),
                  presence: presence,
                  showOpenIcon: false,
                  size: 98,
                ),
                  ...
                  InkWell(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border: Border.all(
                          color:
                              const Color(0xFF12C7B7).withValues(alpha: 0.25),
                        ),
                      ),
                      child: Row(
                        mainAxisSize: MainAxisSize.min,
...
class _PresencePrivacyPanel extends StatelessWidget {
  const _PresencePrivacyPanel({
    required this.presence,
    required this.lastSeenText,
    required this.currentRoomName,
    required this.onTap,
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: isOnline
                      ...
                      : const Color(0xFF8C8198).withValues(alpha: 0.12),
                  borderRadius: BorderRadius.circular(18),
                ),
                child: Icon(
                  isOnline ? Icons.circle_rounded : Icons.schedule_rounded,
                  color: isOnline
                      ? const Color(0xFF12C7B7)
                  ...
                  children: [
                    ...
                    Text(
                      currentRoomName == null
                          ? lastSeenText
                          : '$lastSeenText · In chatroom: $currentRoomName',
                      maxLines: 2,
                      overflow: TextOverflow.ellipsis,
                      style: const TextStyle(
                        color: Color(0xFF7A6B86),
                    ...
                    const Text(
                      'Secret Vibe rooms and hidden presence will stay private.',
                      style: TextStyle(
                        color: Color(0xFFE84C72),
                        fontSize: 11,
    ...
    return Row(
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            color:
                isOnline ? const Color(0xFF12C7B7) : const Color(0xFFB8B0C2),
            shape: BoxShape.circle,
          ),
        ),
...
class _NameWithOfficialTick extends StatelessWidget {
  const _NameWithOfficialTick({
    required this.displayName,
    required this.role,
  ...
  bool get _showYellowTick {
    final normalizedRole = role.toLowerCase().trim();
    return normalizedRole == 'founder_owner' ||
        normalizedRole == 'super_owner' ||
...
class _OfficialYellowTick extends StatelessWidget {
  const _OfficialYellowTick({
    this.size = 21,
  });
  ...
  Widget build(BuildContext context) {
    return Icon(
      ...
      shadows: [
        ...
        Shadow(
          color: const Color(0xFF251538).withValues(alpha: 0.25),
          blurRadius: 4,
          offset: const Offset(0, 1),
        ),
      ],
...
class _FamilyTagLight extends StatelessWidget {
  const _FamilyTagLight({
    required this.familyName,
    required this.familyLevel,
    required this.onTap,
  });
    ...
    return Material(
      ...
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            color: const Color(0xFF12C7B7).withValues(alpha: 0.16),
            borderRadius: BorderRadius.circular(99),
            border: Border.all(
              color: const Color(0xFF12C7B7).withValues(alpha: 0.35),
            ),
          ),
          child: Row(
            mainAxisSize: MainAxisSize.min,
            children: [
              const Icon(
                ...
                color: Color(0xFF93FFF4),
                size: 14,
              ),
              const SizedBox(width: 6),
              Flexible(
                child: Text(
                  '$familyName · Family Lv. $familyLevel',
                  maxLines: 1,
                  overflow: TextOverflow.ellipsis,
                  style: const TextStyle(
                    color: Colors.white,
...
class _BioInfoPanel extends StatelessWidget {
  const _BioInfoPanel({
    required this.bio,
    required this.age,
...
class _VibesRulesPanel extends StatelessWidget {
  const _VibesRulesPanel({
    required this.onTap,
  });
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 4),
                    Text(
                      'Photos, videos, captions, comments, @name and @all notifications.',
                      style: TextStyle(
                        color: Colors.white.withValues(alpha: 0.78),
                        fontSize: 12,
                        height: 1.25,
...
class _MyVibeCard extends StatelessWidget {
  const _MyVibeCard({
    required this.vibe,
    required this.onTap,
  ...
  @override
  Widget build(BuildContext context) {
    final mentionText = vibe.usesMentionAll
        ? '@all followers'
        : vibe.mentions.isEmpty
            ? 'No mentions'
            : vibe.mentions.map((name) => '@$name').join(', ');
...
class _VipSvipPanel extends StatelessWidget {
  const _VipSvipPanel({
    required this.vipLevel,
    required this.svipLevel,
    required this.vipFrozen,
...
class _RelationshipHolder extends StatelessWidget {
  const _RelationshipHolder({
              ...
              const Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 2),
                    Text(
                      'Love, bestie and brother/sister bonds',
                      style: TextStyle(
                        color: Color(0xFF7A6B86),
                        fontSize: 12,
                        fontWeight: FontWeight.w600,
            ...
            children: [
              ...
              Expanded(
                child: _RelationshipCard(
                  ...
                  name: relationshipLabel == 'Sister' ? 'Meera' : 'Akhil',
                  avatarText: relationshipLabel == 'Sister' ? 'M' : 'A',
...
class _RelationshipCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final isLove = title == 'Love';
    final isBestie = title == 'Bestie';
      ...
      child: Container(
        ...
        child: Stack(
          children: [
            Positioned.fill(
              child: CustomPaint(
                painter: _IndianBondPatternPainter(
...
class _IndianBondPatternPainter extends CustomPainter {
  const _IndianBondPatternPainter({
    required this.color,
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (double x = -18; x < size.width + 18; x += 28) {
      for (double y = -12; y < size.height + 18; y += 28) {
    ...
    if (isLove) {
      final path = Path()
        ...
        ..cubicTo(size.width * 0.22, size.height * 0.06, size.width * 0.42,
            size.height * 0.12, size.width * 0.50, size.height * 0.26)
        ..cubicTo(size.width * 0.58, size.height * 0.12, size.width * 0.78,
            size.height * 0.06, size.width * 0.84, size.height * 0.20);
      ...
      canvas.drawCircle(Offset(size.width * 0.34, size.height * 0.22), 5, accent);
      canvas.drawCircle(Offset(size.width * 0.66, size.height * 0.22), 5, accent);
    } else {
      canvas.drawLine(
      ...
      for (double x = size.width * 0.30; x <= size.width * 0.70; x += 14) {
        canvas.drawCircle(Offset(x, size.height * 0.24), 3.2, accent);
      }
    }
  }

  @override
  bool shouldRepaint(covariant _IndianBondPatternPainter oldDelegate) {
    return oldDelegate.color != color ||
        oldDelegate.isLove != isLove ||
        oldDelegate.isBestie != isBestie;
  }
}
    ...
    return Expanded(
      child: InkWell(
        ...
        child: Container(
          ...
          decoration: _whitePanelDecoration(radius: 20),
          child: Column(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Icon(
...
const _mockMyVibes = [
  _MyVibeItem(
    title: 'Building Vibe Match',
    body:
        'Working on a premium live audio app with rooms, Vibes, VIP, SVIP, gifts and social connections. Mentioned @all for feedback.',
    timeAgo: '2h ago',
    tag: 'Update',
    likes: '1.2K',
    comments: '86',
  ...
  _MyVibeItem(
    title: 'Late Night Music Rooms',
    body:
        'Music rooms should feel clean, emotional and premium. Thanks @riya and @akhil for the feedback.',
    timeAgo: 'Yesterday',
    tag: 'Music',
    likes: '846',
    comments: '42',
  ...
  _MyVibeItem(
    title: 'Premium Profile Design',
    body:
        'Profiles need to show identity clearly: bio, age, gender, interests, VIP/SVIP, CP, user Vibes, online status, last seen and visible room status.',
    timeAgo: '3d ago',
    tag: 'Design',
    likes: '2.4K',
    comments: '171',
