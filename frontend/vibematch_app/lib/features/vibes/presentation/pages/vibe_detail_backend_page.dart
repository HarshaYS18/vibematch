    ...
    return ColoredBox(
      ...
      child: Column(
        ...
        children: [
          ...
          if (!isTextVibe) SizedBox(width: size, height: size, child: ClipRect(child: VibeMediaPlayer(vibe: vibe, onDoubleTap: () {}))),
          _PostInfo(vibe: vibe, caption: _caption, isTextVibe: isTextVibe),
...
class _PostInfo extends StatelessWidget {
  const _PostInfo({required this.vibe, required this.caption, required this.isTextVibe});
  final VibeItem vibe;
