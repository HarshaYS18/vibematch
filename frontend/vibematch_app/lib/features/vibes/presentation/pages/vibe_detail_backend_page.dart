      ...
      child: Row(
        children: [
          CircleAvatar(
            ...
            child: Text(vibe.avatarText, style: const TextStyle(color: Colors.white, fontWeight: FontWeight.w900)),
          ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: vibe.colors.first.withValues(alpha: 0.20), blurRadius: 18, offset: const Offset(0, 9)),
        ],
      ),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
    ...
    return Row(
      children: [
        ...
        if (loading)
          ...
          Text('$count total', style: const TextStyle(color: Color(0xFF7B6A86), fontSize: 12, fontWeight: FontWeight.w800)),
          ...
          InkWell(
            ...
            child: Container(
              ...
              child: sending
                  ...
                  : const Icon(VMIcons.send, color: Colors.white),
            ),
          ),
        ],
      ),
  ...
  Widget build(BuildContext context) {
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(color: color.withValues(alpha: 0.11), borderRadius: BorderRadius.circular(999), border: Border.all(color: color.withValues(alpha: 0.20))),
        child: Row(
...
class _EmptyCommentsCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const _WhiteCard(
      child: Text('No comments yet. Be the first to comment.', style: TextStyle(color: Color(0xFF7B6A86), fontWeight: FontWeight.w800)),
    );
  }
}
