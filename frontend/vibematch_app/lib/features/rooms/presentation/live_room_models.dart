...
const List<GiftItem> mockGiftItems = [
  ...
  GiftItem(
    ...
    chatSymbol: '⭐',
    assetPath: 'assets/gifts/lucky/lucky_star.webp',
    colors: [Color(0xFFFFD166), Color(0xFF6D5DF6)],
  ),
  GiftItem(
    id: 'crystal_box',
    name: 'Crystal Box',
    ...
    chatSymbol: '💎',
    assetPath: 'assets/gifts/lucky/crystal_box.webp',
  ...
  GiftItem(
    ...
    icon: Icons.rocket_launch_rounded,
    chatSymbol: '🚀',
    assetPath: 'assets/gifts/lucky/jackpot_rocket.webp',
    videoAssetPath: 'assets/videos/gifts/love_rocket.mp4',
