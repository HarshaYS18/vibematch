...
const List<SeatUser> mockRoomUsers = [
  SeatUser(id: 'founder_owner', name: 'Harsha', roleLabel: 'Channel Host', familyName: 'Moon Fam', familyLevel: 'platinum', relationshipText: 'Love: Riya • Bonds: Arjun, Kiran', vipLevel: 32, svipLevel: 3, sendingLevel: 52, receivingLevel: 44, sentExp: 98200, receivedExp: 124500, medals: ['🏆', '💎', '🔥'], avatarColors: [Color(0xFFFFC857), Color(0xFFFF5F7E)], gender: RoomUserGender.male, age: 27, locationLabel: 'Vijayawada, India', isCurrentUser: true, isHost: true, isRoomAdmin: true),
  SeatUser(id: 'riya', name: 'Riya', roleLabel: 'Administrator', familyName: 'Moon Fam', familyLevel: 'gold', relationshipText: 'Love: Harsha • Bonds: Meera', vipLevel: 28, svipLevel: 1, sendingLevel: 41, receivingLevel: 38, sentExp: 65400, receivedExp: 90500, medals: ['🌙', '🎖️'], avatarColors: [Color(0xFF18C7B7), Color(0xFF5E6DFF)], gender: RoomUserGender.female, age: 24, locationLabel: 'Hyderabad, India', isRoomAdmin: true),
  SeatUser(id: 'arjun', name: 'Arjun', roleLabel: 'Member', familyName: 'Moon Fam', familyLevel: 'silver', relationshipText: 'Bond: Harsha', vipLevel: 18, svipLevel: 0, sendingLevel: 22, receivingLevel: 17, sentExp: 22500, receivedExp: 34100, medals: ['⭐'], avatarColors: [Color(0xFFE84C72), Color(0xFFB13C77)], gender: RoomUserGender.male, age: 25, locationLabel: 'Bengaluru, India'),
];

const List<SeatUser> mockInviteUsers = [
  SeatUser(id: 'meera', name: 'Meera', roleLabel: 'Member', familyName: 'Star House', familyLevel: 'bronze', relationshipText: 'Bond: Riya', vipLevel: 9, svipLevel: 0, sendingLevel: 14, receivingLevel: 11, sentExp: 8800, receivedExp: 12300, medals: ['🌟'], avatarColors: [Color(0xFF7A5CFF), Color(0xFF12C7B7)], gender: RoomUserGender.female, age: 23, locationLabel: 'Chennai, India'),
  ...
  SeatUser(id: 'kiran', name: 'Kiran', roleLabel: 'Member', familyName: 'Moon Fam', familyLevel: 'platinum', relationshipText: 'Bond: Harsha', vipLevel: 13, svipLevel: 0, sendingLevel: 20, receivingLevel: 16, sentExp: 14800, receivedExp: 11600, medals: ['🔥'], avatarColors: [Color(0xFFFFC857), Color(0xFF7A5CFF)], gender: RoomUserGender.male, age: 26, locationLabel: 'Vizag, India', locationVisible: false),
];
