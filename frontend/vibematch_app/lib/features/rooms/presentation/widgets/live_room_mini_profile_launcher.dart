...
class LiveRoomMiniProfileLauncher {
  ...
  static void open({
    ...
    required ValueChanged<String> onRemoveAdminTap,
    required ValueChanged<SeatUser> onReportTap,
    ...
    showModalBottomSheet<void>(
      ...
      builder: (_) => LiveRoomMiniProfileSheet(
        ...
        onRemoveAdminTap: () => onRemoveAdminTap(user.id),
        onReportTap: () => onReportTap(user),
