        ...
        child: Stack(
          ...
          children: [
            SingleChildScrollView(
              padding: EdgeInsets.fromLTRB(14, 48, 14, MediaQuery.paddingOf(context).bottom + 10),
              ...
              child: Column(
                ...
                children: [
                  ...
                  _StatsLine(
                    followers: user.receivedExp,
                    followed: user.sentExp,
                    onFollowersTap: onReceivedRankingTap,
                    onFollowedTap: onSentRankingTap,
                  ),
                  const SizedBox(height: 9),
                  _MiniActionRow(
                    onVipTap: onVipTap,
            ...
            Positioned(top: -36, child: _Avatar(user: user, onTap: onAvatarTap)),
          ],
        ),
      ),
    );
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [BoxShadow(color: RoomColors.gold.withValues(alpha: 0.28), blurRadius: 18, offset: const Offset(0, 8))],
            ),
          ),
          Container(
            width: 64,
    ...
    return Container(
      ...
      child: Row(mainAxisSize: MainAxisSize.min, children: [
        ...
        ConstrainedBox(
          ...
          child: Text(label.toUpperCase(), maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(color: Colors.white, fontSize: 9.5, fontWeight: FontWeight.w900)),
        ),
      ]),
    );
  }
...
class _StatsLine extends StatelessWidget {
  const _StatsLine({
    ...
    required this.onFollowedTap,
  });

  final int followers;
  final int followed;
  final VoidCallback onFollowersTap;
  final VoidCallback onFollowedTap;

  @override
  Widget build(BuildContext context) {
    return Row(mainAxisAlignment: MainAxisAlignment.center, children: [
      _FollowStat(value: compactNumber(followers), label: 'Followers', onTap: onFollowersTap),
      Container(width: 1, height: 16, margin: const EdgeInsets.symmetric(horizontal: 16), color: const Color(0xFFE2D8D0)),
      _FollowStat(value: compactNumber(followed), label: 'Followed', onTap: onFollowedTap),
    ]);
  }
}
...
class _SendGiftButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
        ...
        decoration: BoxDecoration(borderRadius: BorderRadius.circular(999), gradient: const LinearGradient(colors: [Color(0xFFFFC107), Color(0xFFFF4F39)]), boxShadow: [BoxShadow(color: const Color(0xFFFF6A30).withValues(alpha: 0.18), blurRadius: 14, offset: const Offset(0, 6))]),
...
class _MoreMenuButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return PopupMenuButton<String>(
      ...
      child: Container(width: 28, height: 28, decoration: BoxDecoration(color: RoomColors.plum.withValues(alpha: 0.08), shape: BoxShape.circle), child: const Icon(Icons.more_horiz_rounded, color: RoomColors.plum, size: 19)),
    );
  }
}
