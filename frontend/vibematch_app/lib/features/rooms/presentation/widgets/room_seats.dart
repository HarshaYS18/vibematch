      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
            ...
            child: user == null ? _EmptySeatLabel(index: seat.index, metrics: metrics) : _UserSeatLabel(user: user, index: seat.index, metrics: metrics),
          ),
        ],
      ),
    );
    ...
    final avatarFrame = RoomAvatarFrameHost(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: Border.all(
            color: selected ? Colors.white.withValues(alpha: 0.78) : Colors.white.withValues(alpha: 0.12),
            width: selected ? 1.05 : 0.75,
          ),
        ),
    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          if (selected)
            Container(
              width: metrics.avatarSize + 5,
              height: metrics.avatarSize + 5,
              decoration: BoxDecoration(shape: BoxShape.circle, border: Border.all(color: Colors.white.withValues(alpha: 0.82), width: 1.0)),
            ),
  ...
  Widget build(BuildContext context) => Positioned(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        color: color,
        shape: BoxShape.circle,
        border: Border.all(color: RoomColors.deep, width: 0.9),
        boxShadow: glow == null ? null : [BoxShadow(color: glow!, blurRadius: 6, offset: const Offset(0, 2))],
      ),
...
class _EmptySeatLabel extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Center(
    child: Text(
      ...
      style: TextStyle(color: Colors.white.withValues(alpha: 0.52), fontSize: metrics.emptyFontSize, fontWeight: FontWeight.w600, height: 1),
    ),
  );
}
...
class _UserSeatLabel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        Container(
          width: metrics.labelHeight - 4,
          height: metrics.labelHeight - 4,
          alignment: Alignment.center,
          decoration: BoxDecoration(color: chipColor, shape: BoxShape.circle),
          child: Text('${index + 1}', style: TextStyle(color: Colors.white, fontSize: metrics.nameFontSize * 0.58, fontWeight: FontWeight.w700, height: 1)),
        ),
        const SizedBox(width: 3),
        Flexible(
          child: Text(user.name, maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(color: Colors.white, fontSize: metrics.nameFontSize, fontWeight: FontWeight.w600, height: 1)),
        ),
      ],
    );
  }
            ...
            Material(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [BoxShadow(color: Colors.black.withValues(alpha: 0.13), blurRadius: 10, offset: const Offset(0, 5))],
                ),
                child: Column(mainAxisSize: MainAxisSize.min, children: [
...
class _MenuButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) => InkWell(
    ...
    child: SizedBox(
      ...
      child: Center(child: Text(action.label, maxLines: 1, overflow: TextOverflow.ellipsis, style: const TextStyle(color: Colors.white, fontSize: 10.2, fontWeight: FontWeight.w600, height: 1))),
    ),
  );
}
