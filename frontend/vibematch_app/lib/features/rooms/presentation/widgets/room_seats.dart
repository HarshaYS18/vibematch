    ...
    return Stack(
      ...
      children: [
        GestureDetector(
          ...
          onTap: () =>
              user == null ? onSeatTap(seat.index) : onUserTap(seat.index),
          child: Column(
      ...
      children: [
        AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            gradient: user == null
                ? null
                : LinearGradient(colors: user.avatarColors),
            border: Border.all(
              color: selected
                  ? RoomColors.gold
                  : Colors.white.withValues(alpha: user == null ? 0.13 : 0.22),
              width: selected ? 2 : 1,
            ),
            boxShadow: user == null
                ? []
                : [
                    BoxShadow(
                      color: user.avatarColors.first.withValues(alpha: 0.20),
                      blurRadius: 12,
        ...
        if (user?.muted ?? false)
          Positioned(
            ...
            child: Container(
              ...
              height: 18,
              decoration: BoxDecoration(
                color: user!.adminMuted
                    ? RoomColors.adminMute
                    : RoomColors.selfMute,
                shape: BoxShape.circle,
...
class _SeatActionOverlay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Material(
      ...
      child: Container(
        width: actions.length == 1 ? 116 : 128,
