            ...
            child: Column(
              children: [
                ...
                _BottomPanel(
                  ...
                  totalPlaced: _placedByTarget.values.fold<int>(
                    0,
                    (sum, item) => sum + item,
                  ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  roundId == null ? 'Room coin game' : 'Round #$roundId',
                  style: TextStyle(
        ...
        return Stack(
          children: [
            ...
            for (var i = 0; i < targets.length; i++)
              Positioned(
                left: center.dx +
                    math.cos(-math.pi / 2 + math.pi * 2 * i / targets.length) * radius -
                    item / 2,
                top: center.dy +
                    math.sin(-math.pi / 2 + math.pi * 2 * i / targets.length) * radius -
                    item / 2,
                width: item,
                child: _TargetTile(
                  target: targets[i],
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                gradient: LinearGradient(
                  colors: winner
                      ? const [Color(0xFFFFF176), Color(0xFFFF8F00)]
                      : selected
                          ? const [Color(0xFF41F7A9), Color(0xFF087D54)]
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          gradient: const LinearGradient(
            colors: [Color(0xFFFFE8A8), Color(0xFFFF9E2D)],
          ),
          border: Border.all(color: const Color(0xFF71370E), width: 8),
        ),
        child: Text(
          active ? '${secondsLeft}s' : result == null ? 'START' : 'NEXT',
          style: const TextStyle(
            color: Color(0xFF4A210A),
            fontSize: 28,
            fontWeight: FontWeight.w900,
          ),
        ),
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          gradient: LinearGradient(
            colors: selected
                ? const [Color(0xFFFFF176), Color(0xFFFF8F00)]
                : const [Color(0xFF2D8CFF), Color(0xFF053D90)],
          ),
          border: Border.all(
            color: Colors.white.withValues(alpha: selected ? 0.72 : 0.25),
...
class _ResultBanner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: won ? const Color(0xFF0B7D3B) : const Color(0xFF5A3212),
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: const Color(0xFFFFD36A)),
      ),
      child: Text(
        won
            ? 'You won ${_money(result.totalUserWinnings)} coins'
            : 'Winning target: ${result.winningTargetId}',
...
_AnimalDisplay _display(GameTarget target) {
  ...
  final map = <String, _AnimalDisplay>{
    'lion': const _AnimalDisplay(
      'assets/games/jungle_hunt/animals/animal_lion.png',
      '🦁',
    ),
    'tiger': const _AnimalDisplay(
      'assets/games/jungle_hunt/animals/animal_tiger.png',
      '🐯',
    ),
    'elephant': const _AnimalDisplay(
      'assets/games/jungle_hunt/animals/animal_elephant.png',
      '🐘',
    ),
    'panda': const _AnimalDisplay(
      'assets/games/jungle_hunt/animals/animal_panda.png',
      '🐼',
    ),
    'monkey': const _AnimalDisplay(
      'assets/games/jungle_hunt/animals/animal_monkey.png',
      '🐵',
    ),
    'fox': const _AnimalDisplay(
      'assets/games/jungle_hunt/animals/animal_fox.png',
      '🦊',
    ),
    'rabbit': const _AnimalDisplay(
      'assets/games/jungle_hunt/animals/animal_rabbit.png',
      '🐰',
    ),
    'deer': const _AnimalDisplay(
      'assets/games/jungle_hunt/animals/animal_deer.png',
      '🦌',
    ),
    'shark': const _AnimalDisplay(
      'assets/games/jungle_hunt/animals/animal_shark.png',
      '🦈',
    ),
    'dolphin': const _AnimalDisplay(
      'assets/games/jungle_hunt/animals/animal_shark.png',
      '🐬',
    ),
    'croc': const _AnimalDisplay(
      'assets/games/jungle_hunt/animals/animal_crocodile.png',
      '🐊',
    ),
    'eagle': const _AnimalDisplay(
      'assets/games/jungle_hunt/animals/animal_eagle.png',
      '🦅',
    ),
    'dragon': const _AnimalDisplay(
      'assets/games/jungle_hunt/animals/animal_dragon.png',
      '🐉',
    ),
  };
