    ...
    if (_currentUser == null) {
      return _LoginScreen(
        ...
        onGoogleLoginPressed: () => _loginWithDevAccount(
          email: 'mvp.user@vibematch.dev',
          username: 'mvp_user',
          displayName: 'MVP Tester',
        ),
      );
    }
...
class _LoadingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Scaffold(
      ...
      body: Center(
        child: CircularProgressIndicator(color: Color(0xFF5B176A)),
      ),
    );
  }
}
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          Positioned.fill(
            child: CustomPaint(painter: _OrbitLinePainter()),
          ),
        ...
        child: Ink(
          ...
          decoration: BoxDecoration(
            ...
            gradient: const LinearGradient(
              ...
              colors: [Color(0xFF5B176A), Color(0xFF6E2379), Color(0xFF4D145E)],
            ),
            boxShadow: [
              BoxShadow(
                color: const Color(0xFF5B176A).withValues(alpha: 0.24),
                blurRadius: 26,
              ...
              Container(
                ...
                child: isLoading
                    ? const Padding(
                        ...
                        child: CircularProgressIndicator(strokeWidth: 2.2, color: Color(0xFF5B176A)),
                      )
                    : Icon(icon, color: const Color(0xFF5B176A), size: 29),
              ),
...
class _LoginErrorBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Text(
        error,
        style: const TextStyle(color: Color(0xFFE84C72), fontSize: 12, fontWeight: FontWeight.w800),
      ),
    );
  }
}
