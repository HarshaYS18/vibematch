...
class LiveRoomForegroundService : Service() {
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        val roomId = intent?.getStringExtra(EXTRA_ROOM_ID)?.takeIf { it.isNotBlank() } ?: "FunKey"
    ...
    private fun buildNotification(roomName: String, roomId: String): Notification {
        return NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .setContentTitle("FunKey live room active")
    ...
    private fun ensureNotificationChannel() {
        ...
        val channel = NotificationChannel(
            ...
            description = "Keeps FunKey live room microphone and audio active while the room is open."
            setShowBadge(false)
    ...
    companion object {
        const val CHANNEL_ID = "funkey_live_room_audio_v2"
