...
Provides repeatable incident and maintenance procedures.

## Responsibilities

Operational response guidance and evidence collection, not runtime control.
...
`docs/runbooks/README.md`, `docs/runbooks`.

## Public API/contracts

Human operator procedures. Keep existing Flutter-compatible paths and payloads until a versioned migration is ready.
...
Limit production commands to approved roles; capture audit trail and avoid secret dumps. Do not log tokens, credentials, private content, or payment secrets.

## Failure modes

Use symptoms, immediate actions, safe mitigation, validation, and escalation for each incident.
...
Documentation active; procedures need staging drills and environment-specific values.
