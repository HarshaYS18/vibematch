...
gateway, users/rooms use 32 route shards and priority queues. A hot room is any room with at least 500 local subscribers; metrics expose hot-room count and maximum local
