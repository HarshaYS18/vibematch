...
ALTER TABLE game_sessions OWNER TO funkey_game_platform_owner;
...
REVOKE ALL ON TABLE game_definitions,game_sessions,game_rounds,game_round_players,game_bets,game_risk_audits,user_game_stats FROM PUBLIC;
